    ...
    <>
      ...
      <header className="hidden lg:flex fixed top-0 left-0 right-0 z-[999] justify-center px-6 py-2">
        <nav className="relative overflow-hidden flex items-center w-full max-w-[1080px] bg-[#f8f7f5] rounded-xl px-4 py-2.5 shadow-[0_1px_12px_rgba(38,27,7,0.08)] border border-[#d6cdb8]/40">
          ...
          />
          {/* Logo */}
          <Link href="/" className="relative flex items-center gap-2.5 pr-8">
            <Image
          ...
          <div className="relative flex items-center gap-1">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="flex items-center gap-1 px-4 py-1.5 rounded-lg text-[14px] font-medium text-[#261b07]/60 hover:text-[#261b07] hover:bg-[#261b07]/[0.06] transition-all"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="relative flex items-center gap-2 ml-auto">
            <Link
              href="/login"
              className="px-4 py-1.5 rounded-lg text-[14px] font-medium text-[#261b07]/60 hover:text-[#261b07] hover:bg-[#261b07]/[0.06] transition-all"
            >
              Inloggen
            </Link>
            <Link
              href="/signup"
              className="inline-flex items-center justify-center rounded-lg bg-[#261b07] px-5 py-2 text-[14px] font-semibold text-[#f8f7f5] hover:bg-[#3a2c14] transition-colors"
            >
              Gratis starten
            </Link>
          </div>
      ...
      <div
        className="relative z-0 min-h-screen bg-[#f8f7f5] text-[#261b07]"
      ...
      >
        ...
        <main className="flex flex-col">
            ...
            <section className="relative pt-10 lg:pt-28 pb-10">
              <div className="mx-auto max-w-[980px] px-[30px] text-center">
                ...
                <p className="mx-auto max-w-[534px] text-[16px] sm:text-[18px] leading-[1.5] text-[color:rgba(38,27,7,0.72)] mb-10">
                  Bunyan helpt moskeeën donaties te ontvangen via iDEAL,
                  ANBI-giftenverklaringen automatisch te genereren en een
                  compleet beeld van hun gemeenschap op te bouwen — zodat u niet
                  alleen ontvangt, maar ook begrijpt.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  ...
                  >
                    <svg
                      ...
                      fill="currentColor"
                    >
                      <path d="M6 3.5L12 8 6 12.5V3.5z" />
                    </svg>
                    Bekijk demo
                  </a>
                </div>
          ...
          <section
            id="prijzen"
            className="relative py-28 sm:py-40 bg-[#eceae5]"
          >
            <div className="mx-auto max-w-[1040px] px-6 sm:px-[30px]">
              ...
              <div className="text-center mb-16">
                ...
                <p className="mx-auto max-w-[420px] text-[15px] leading-[1.65] text-[color:rgba(26,21,16,0.5)]">
                  Begin gratis en groei mee. Geen transactiekosten bovenop
                  Stripe, geen verborgen limieten — alleen de tools die uw
                  moskee nodig heeft.
                </p>
              </div>
                      ...
                      <div className="flex-1 p-7">
                        ...
                        <ul className="space-y-2.5">
                          {[
                            ...
                            <li
                              key={f}
                              className="flex items-center gap-2.5 text-[13px] text-[#1a1510]"
                            >
                              <svg
                                className="w-[15px] h-[15px] flex-shrink-0 text-[color:rgba(26,21,16,0.35)]"
                                viewBox="0 0 16 16"
                                fill="none"
                                stroke="currentColor"
                                strokeWidth="1.4"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={label}>
                      <a
                        href={href}
                        className="text-[15px] text-[#1a1510] hover:opacity-50 transition-opacity"
                      >
                        {label}
                      </a>
                    </li>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {[
                    {
                      label: "Donatiebeheer voor moskeeën",
                      href: "/donatiebeheer-moskee",
                    },
                    {
                      label: "Online doneren voor moskeeën",
                      href: "/online-doneren-moskee",
                    },
                    {
                      label: "ANBI-giftenverklaringen",
                      href: "/anbi-giftenverklaring-moskee",
                    },
                    {
                      label: "Leden- & donorprofielen",
                      href: "/ledenbeheer-moskee",
                    },
                    {
                      label: "Periodieke giften voor moskeeën",
                      href: "/periodieke-giften-moskee",
                    },
                    {
                      label: "QR-code donatiepagina",
              ...
              <div className="flex flex-col gap-3">
                <div className="rounded-[10px] bg-[#c6e535] px-4 py-3 flex items-center justify-between">
                  <span className="text-[14px] font-medium text-[#2a3800]">
                    Volg ons
                  </span>
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      className="w-8 h-8 rounded-[6px] bg-[#2a3800]/10 hover:bg-[#2a3800]/20 flex items-center justify-center transition-colors"
                    >
                      <svg
                        className="w-4 h-4 text-[#2a3800]"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                      >
                    ...
                    >
                      <svg
                        className="w-[15px] h-[15px] text-[#2a3800]"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                      >
