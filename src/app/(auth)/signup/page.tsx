    ...
    return (
      <div>
        ...
        <p className="text-[15px] text-[#a09888] mb-6">
          We hebben een bevestigingslink gestuurd naar <span className="font-medium text-[#261b07]">{email}</span>
        </p>
        <p className="text-[14px] text-[#a09888] mb-8">
          Klik op de link in de e-mail om uw account te activeren en door te gaan met de configuratie. Controleer ook uw spam folder.
        </p>
        <button
          onClick={() => {
