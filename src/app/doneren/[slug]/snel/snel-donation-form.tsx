...
export function SnelDonationForm({
  mosqueSlug,
  mosqueName,
  primaryColor,
  funds,
  ...
  const isValidAmount =
    activeAmount >= MIN_AMOUNT && activeAmount <= MAX_AMOUNT;
  ...
  async function handleDonate() {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Betaling aanmaken mislukt",
      );
    } finally {
      setLoading(false);
    }
          ...
          return (
            ...
            >
              <span
                ...
                style={{
                  fontFamily:
                    "var(--font-display), var(--font-sans), system-ui",
                }}
              >
                {"\u20AC"}
                {preset}
        ...
        <div className="mt-3">
          ...
          >
            ...
            <input
              ...
              className="flex-1 bg-transparent text-xl sm:text-2xl font-bold outline-none ml-2 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
              style={{
                color: "#1B2541",
    ...
    <div className="mx-auto max-w-lg w-full">
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-xs" style={{ color: "#9B8E7B" }}>
            {mosqueName}
          </p>
        </div>
      </div>
