...
export default async function OnboardingLayout({
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#f8f7f5]">
      ...
      {/* Content */}
      <div className="flex flex-1 items-start sm:items-center justify-center px-5 sm:px-6 pt-4 sm:pt-0 overflow-y-auto">
        {children}
      </div>
      ...
      <div className="flex items-center justify-center gap-6 px-4 pb-4 sm:px-8 sm:pb-6">
        <a
          href="#"
          className="text-[13px] text-[#b5b0a5] hover:text-[#8a8478] transition-colors"
        >
          Voorwaarden
        </a>
        <a
