        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-16 lg:gap-20 items-start">
          ...
          <div>
            ...
            <p className="text-[15px] leading-[1.65] text-[color:rgba(26,21,16,0.6)] mb-8 max-w-[380px]">
              Heeft u vragen over Bunyan, wilt u een demo of overweegt u het Enterprise-pakket? Laat een bericht achter en we reageren binnen één werkdag.
            </p>
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-[14px] text-[color:rgba(26,21,16,0.6)]">
                <svg className="w-5 h-5 flex-shrink-0 text-[#261b07]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div>
            {status === "sent" ? (
              <div className="rounded-[14px] border border-[#c6e535] bg-[#c6e535]/10 p-10 text-center">
                <svg className="w-12 h-12 mx-auto mb-4 text-[#4a6600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="contact-name" className="block text-[12px] font-semibold tracking-[0.4px] uppercase text-[color:rgba(26,21,16,0.45)] mb-2">
                  ...
                  <div>
                    <label htmlFor="contact-email" className="block text-[12px] font-semibold tracking-[0.4px] uppercase text-[color:rgba(26,21,16,0.45)] mb-2">
                ...
                <div>
                  <label htmlFor="contact-phone" className="block text-[12px] font-semibold tracking-[0.4px] uppercase text-[color:rgba(26,21,16,0.45)] mb-2">
                    Telefoonnummer
                  </label>
                  <input
                    id="contact-phone"
                ...
                <div>
                  <label htmlFor="contact-message" className="block text-[12px] font-semibold tracking-[0.4px] uppercase text-[color:rgba(26,21,16,0.45)] mb-2">
