      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Label>Methode *</Label>
              <RadioGroup value={method} onValueChange={(v) => setMethod(v as 'cash' | 'bank_transfer')}>
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="cash" id="method-cash" />
                    <Label htmlFor="method-cash" className="font-normal">Contant</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="bank_transfer" id="method-bank" />
                    <Label htmlFor="method-bank" className="font-normal">Overboeking</Label>
                  </div>
                </div>
              </RadioGroup>
            </div>
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                placeholder="Bijv. collectebus vrijdaggebed"
                rows={2}
              />
            </div>
          </div>
