        ...
        {campaigns.map((campaign) => (
          <Card key={campaign.id}>
            ...
            <CardContent className="space-y-2">
              ...
              <p className="text-sm">Fonds: {campaign.funds?.name}</p>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Weet u zeker dat u &ldquo;{archiveTarget?.title}&rdquo; wilt
              archiveren? De campagne wordt verborgen maar de gegevens blijven
              bewaard.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
    ...
    <div className="flex items-center gap-1.5 pt-1">
      <div className="flex-1 min-w-0 flex items-center rounded-md bg-muted/50 border border-border/60 px-2.5 py-1.5">
        <span className="text-[11px] text-muted-foreground truncate">
          /doneren/{mosqueSlug}/{campaignSlug}
        </span>
      </div>
      <button
        onClick={handleCopy}
