      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.tableHeaderCell, styles.colCount]}>Aantal</Text>
            <Text style={[styles.tableHeaderCell, styles.colAmount]}>Bedrag</Text>
          </View>
        ...
        <View style={styles.statement}>
          <Text style={styles.statementText}>
            Hierbij verklaart ondergetekende dat {data.mosqueName} (RSIN:{' '}
            {data.rsin}) is aangemerkt als Algemeen Nut Beogende Instelling
